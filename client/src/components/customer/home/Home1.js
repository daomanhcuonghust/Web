        ...
        <div className='Home1'>
            ...
            <Row>
                <Col style={{marginLeft:'100px', marginRight:'60px', paddingTop:'80px'}}>
                    ...
                    <Button style={{backgroundColor: '#F05454', border:'none'}}size="lg">Đặt vé ngay</Button> {' '}
                    <Button variant="outline-secondary" size="lg">Khám phá</Button>
                </Col>
            ...
            <div className='homeComponent'>
                ...
                <Row>
                    ...
                    <Card className='homeCard' >
                        ...
                        <Card.Img className='homeCardImg' variant="top" src="https://banahills.sunworld.vn/wp-content/uploads/2021/04/DEM-BN-1024x752.jpg" />
                        ...
                        <Card.Footer className='homeCardFooter' style={{borderRadius: '0 0 50px 0px'}}>Xem thêm</Card.Footer>
                    </Card>
                    </Col>
